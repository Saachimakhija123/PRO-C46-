...
player2Img=loadImage("images/player2.png");
  ...
  player1=createSprite(400,20,10,10);
  player1.addImage(player1Img);
  player1.scale=0.3;
 
  

  player2=createSprite(600,120,10,10);
  player2.addImage(player2Img);
  player2.scale=0.3;
  

  player3=createSprite(600,20,10,10);
  player3.addImage(player1Img);
  player3.scale=0.3;

  player4=createSprite(500,120,10,10);
  player4.addImage(player2Img)
  player4.scale=0.3;
 
  
  player5=createSprite(800,120,10,10);
